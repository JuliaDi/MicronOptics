 ...
 *  from interrogator is established. Make sure to check that PC NIC is set to 
 *  10.0.0.121 with mask 255.255.255.0 in order to run.
 *  Changes: 
 *      03/16/2017 - Michael L. re-writing all code
 *      05/06/2021 - Julia D. add comment
*/
void initInterrogator(){ 
